                ...
                if (imageView.getId().equals(hareketliEngel.getAd())) {
                    switch (hareketliEngel.hareketYonu) {
                        case "Y":
                            ...
                            asagiHareket.setByY(hareketliEngel.hareketBoyutu); // Resmi HAREKET_UZAKLIGI kadar sağa hareket ettirin
                        ...
                        case "X":
                            ...
                            solaHareket.setByX(hareketliEngel.hareketBoyutu); // Resmi HAREKET_UZAKLIGI kadar sola hareket ettirin
